...
public class ObjectiveBuilder {
	...
	private CompletableObjective buildSubObjective(ConditionalObjective composite, JSONArray components) {
	...
	// if there are multiple objective leafs of the same type (eg. contained in more than one composite
	//
