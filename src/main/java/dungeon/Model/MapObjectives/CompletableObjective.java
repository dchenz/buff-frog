 ...
 *  Then the parent (always either AND/OR) will decide if the change has changed their own completeness
 *  It wil update its own status to reflect the change and tell its parent too
 *  
