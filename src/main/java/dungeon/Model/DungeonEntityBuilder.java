...
public class DungeonEntityBuilder extends DungeonBuilder {
	...
	public Player onLoad(Player player) {
		ImageView view =
			new ImageView(new Image(getClass().getResourceAsStream("/images/sprites/player.png"),
	...
	public BarrierEntity onLoad(Wall wall) {
		ImageView view =
			new ImageView(new Image(getClass().getResourceAsStream("/images/sprites/wall.png"),
				TILE_SIZE, TILE_SIZE, true, true));
		addEntity(wall, view);
		return wall;
	}
	...
	public BarrierEntity onLoad(Door door) {
		ImageView view = new ImageView(
			new Image(getClass().getResourceAsStream("/images/sprites/closed_door.png"), TILE_SIZE,
				TILE_SIZE, true, true));
		...
		door.getOpenProperty().addListener(new ChangeListener<Boolean>() {
			...
			public void changed(
				...
				view.setImage(
					new Image(getClass().getResourceAsStream("/images/sprites/open_door.png"),
						TILE_SIZE, TILE_SIZE, true, true));
			}
		});
		addEntity(door, view);
	...
	public BarrierEntity onLoad(Portal portal) {
		ImageView view =
			new ImageView(new Image(getClass().getResourceAsStream("/images/sprites/portal.png"),
				TILE_SIZE, TILE_SIZE, true, true));
	...
	public Enemy onLoad(Enemy enemy) {
		ImageView view =
			new ImageView(new Image(getClass().getResourceAsStream("/images/sprites/enemy.png"),
				TILE_SIZE, TILE_SIZE, true, true));
	...
	public Boulder onLoad(Boulder boulder) {
		ImageView view =
			new ImageView(new Image(getClass().getResourceAsStream("/images/sprites/boulder.png"),
				TILE_SIZE, TILE_SIZE, true, true));
	...
	public FloorSwitch onLoad(FloorSwitch floor) {
		ImageView view =
			new ImageView(new Image(getClass().getResourceAsStream("/images/sprites/switch.png"),
				TILE_SIZE, TILE_SIZE, true, true));
	...
	public Exit onLoad(Exit exit) {
		ImageView view =
			new ImageView(new Image(getClass().getResourceAsStream("/images/sprites/exit.png"),
				TILE_SIZE, TILE_SIZE, true, true));
		addEntity(exit, view);
		return exit;
	}
	...
	public Item onLoad(Treasure treasure) {
		ImageView view =
			new ImageView(new Image(getClass().getResourceAsStream("/images/sprites/treasure.png"),
				TILE_SIZE, TILE_SIZE, true, true));
