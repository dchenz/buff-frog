...
public class Portal extends BarrierEntity {
	...
	public boolean trigger(Player player) {
		...
		return false; // player cannot step onto a portal and be on it (because they will be
					  // teleported)
	}
	...
	public void setConnection(Portal other) {
		...
		assert other.destination == null
			|| other.destination
				== this : "Other portal is already connected to a different portal";
