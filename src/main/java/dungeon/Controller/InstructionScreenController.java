...
public class InstructionScreenController {
	...
	@FXML
	private AnchorPane arrowKeysView;
	...
	public void initialize() {
		...
		leftButton.setOnMouseClicked(prevPane -> {
			prevEntityDescription();
		});

		rightButton.setOnMouseClicked(nextPane -> {
			nextEntityDescription();
		});
	}
