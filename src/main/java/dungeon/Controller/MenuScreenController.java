...
public class MenuScreenController {
	@FXML private StackPane backgroundImage;

	@FXML private AnchorPane mainImage;

	@FXML private AnchorPane gameTitle;
	...
	@FXML private Button sandboxButton;
	...
	public void initialize() {
		String backgroundFile =
			String.format("/images/menu-backgrounds/background%d.jpg", new Random().nextInt(3) + 1);

		mainImage.getChildren().add(0,
			new ImageView(new Image(getClass().getResourceAsStream("/images/app/main-image.png"),
				550, 550, true, true)));
		gameTitle.getChildren().add(new ImageView(new Image(
			getClass().getResourceAsStream("/images/app/title.png"), 400, 250, true, true)));

		ImageView backgroundView = new ImageView(
			new Image(getClass().getResourceAsStream(backgroundFile), 2000, 2000, true, true));
	...
	private void loadSandboxIcon() {
		...
		ImageView image = new ImageView(new Image(
			getClass().getResourceAsStream("/images/app/hammer.png"), 100, 100, true, true));
